...
const About = () => {
  ...
  return <section id="about" className="py-24 bg-gradient-to-br from-accent via-background to-accent relative overflow-hidden">
      {/* Background decorations */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-0 w-72 h-72 bg-primary/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-0 w-96 h-96 bg-primary-glow/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: '2s'
      }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="animate-slide-in-left">
            ...
            <div className="flex items-center space-x-4 mb-8">
              <div className="flex items-center space-x-1">
                {[...Array(5)].map((_, i) => <Star key={i} className="w-6 h-6 text-primary-glow fill-current" />)}
              </div>
          ...
          <div className="animate-slide-in-right">
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => <div key={index} className={`relative bg-white rounded-3xl p-8 text-center shadow-xl hover:shadow-glow transition-all duration-700 transform hover:scale-105 group overflow-hidden animate-bounce-in`} style={{
