        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2 animate-fade-in">
            ...
            {[{
              ...
              icon: Instagram,
              label: "Instagram",
              url: "https://www.instagram.com/mi.taxpro?utm_source=ig_web_button_share_sheet&igsh=bGUxcGxxd3hjbmdv"
          ...
          <div className="animate-slide-in-left">
            ...
            <ul className="space-y-4">
              {["Preparación de Impuestos", "Creación de LLC", "Servicios de Migración"].map((service, index) => <li key={index}>
        ...
        <div className="border-t border-white/20 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-center md:text-left">
              <p>© 2026 MiTaxPro.  Todos los derechos reservados.
